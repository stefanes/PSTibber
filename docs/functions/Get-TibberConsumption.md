...
HelpUri: https://developer.tibber.com/docs/reference#consumption
Locale: sv-SE
Module Name: PSTibber
ms.date: 09-19-2025
PlatyPS schema version: 2024-05-01
title: Get-TibberConsumption
---
...
```
Get-TibberConsumption [-Resolution <string>] [-From <datetime>] [-To <datetime>] [-Last <int>]
